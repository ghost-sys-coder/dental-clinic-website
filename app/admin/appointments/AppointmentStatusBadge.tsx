const STATUS_CONFIG: Record<string, { label: string; cls: string }> = {
  REQUESTED:   { label: "Requested",    cls: "bg-sky-100 text-sky-700 border-sky-200" },
  CONFIRMED:   { label: "Confirmed",    cls: "bg-indigo-100 text-indigo-700 border-indigo-200" },
  CHECKED_IN:  { label: "Checked In",   cls: "bg-cyan-100 text-cyan-700 border-cyan-200" },
  IN_TREATMENT:{ label: "In Treatment", cls: "bg-yellow-100 text-yellow-700 border-yellow-200" },
